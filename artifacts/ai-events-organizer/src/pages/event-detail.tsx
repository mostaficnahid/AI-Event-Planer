            ...
            <Dialog open={isBudgetModalOpen} onOpenChange={setIsBudgetModalOpen}>
              ...
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>Get an AI-powered cost breakdown for your event in USD.</DialogDescription>
                </DialogHeader>
            ...
            <Dialog open={isThemesModalOpen} onOpenChange={setIsThemesModalOpen}>
              ...
              <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>Creative theme ideas and engagement tips generated by AI for your event.</DialogDescription>
                </DialogHeader>
                <div className="py-4">
                    ...
                    <Dialog open={isAddingGuest} onOpenChange={setIsAddingGuest}>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>Enter the guest's name and email to add them to this event.</DialogDescription>
                        </DialogHeader>
