                ...
                <Dialog open={isThemesModalOpen} onOpenChange={setIsThemesModalOpen}>
                  ...
                  <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
                    <DialogHeader>
                      ...
                      <DialogDescription>Creative themes and improvements generated by AI based on your event details.</DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
                    ...
                    <Dialog open={isBudgetModalOpen} onOpenChange={setIsBudgetModalOpen}>
                      ...
                      <DialogContent className="max-w-2xl">
                        <DialogHeader>
                          ...
                          <DialogDescription>An AI-generated cost estimate in USD based on your event details.</DialogDescription>
                        </DialogHeader>
                        <div className="py-4">
